...
public class STAR15_Plot_L1 extends Plot {
    ...
    public Image getImage(int process){
        switch(process){
            ...
            case 1:return Script.AvatarUMP9  (2);
            case 2:return Script.AvatarSTAR45(0);
            case 3:return Script.AvatarSTAR45(1);
            case 4:return Script.AvatarSTAR45(2);
        }
        return null;
    }
    ...
    public String getName(int process){
        switch(process){
            ...
            case 2:return Script.Name(Script.Character.STAR_45);
            case 3:return Script.Name(Script.Character.STAR_45);
            case 4:return Script.Name(Script.Character.STAR_45);
        }
        return null;
    }
    ...
    public static class End extends Plot {
        ...
        public Image getImage(int process){
            switch(process){
                case 0:return Script.AvatarSTAR45(0);
            }
            return null;
        }
        ...
        public String getName(int process){
            switch(process){
                case 0:return Script.Name(Script.Character.STAR_45);
            }
            return null;
        }
