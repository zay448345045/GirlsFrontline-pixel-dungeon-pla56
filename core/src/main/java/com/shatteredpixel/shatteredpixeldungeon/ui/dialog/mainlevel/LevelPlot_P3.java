...
public class LevelPlot_P3 extends Plot {
    ...
    public Image getImage(int process){
        switch(process){
            case 0:return Script.AvatarG11  (0);
            case 1:return Script.AvatarUMP45(2);
            case 2:return Script.AvatarG11  (0);
            case 3:return Script.AvatarUMP45(1);
            case 4:return Script.AvatarG11  (2);
            case 5:return Script.AvatarHK416(1);
            case 6:return Script.AvatarUMP9 (0);
            case 7:return Script.AvatarHK416(1);
            case 8:return Script.AvatarG11  (0);
        }
        return null;
    }
    ...
    public String getName(int process){
        switch(process){
            case 0:return Script.Name(Script.Character.G11  );
            case 1:return Script.Name(Script.Character.UMP45);
            case 2:return Script.Name(Script.Character.G11  );
            case 3:return Script.Name(Script.Character.UMP45);
            case 4:return Script.Name(Script.Character.G11  );
            case 5:return Script.Name(Script.Character.HK416);
            case 6:return Script.Name(Script.Character.UMP9 );
            case 7:return Script.Name(Script.Character.HK416);
