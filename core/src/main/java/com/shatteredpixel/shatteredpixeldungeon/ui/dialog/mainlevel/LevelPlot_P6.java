...
public class LevelPlot_P6 extends Plot {
    ...
    public Image getImage(int process){
        switch(process){
            ...
            case 2:return Script.AvatarUMP9 (1);
            case 3:return Script.AvatarHK416(1);
            case 4:return Script.AvatarG11  (1);
            case 5:return Script.AvatarHK416(1);
            case 6:return Script.AvatarG11  (1);
            case 7:return Script.AvatarUMP45(0);
        }
        return null;
    }
    ...
    public String getName(int process){
        switch(process){
            ...
            case 6:return Script.Name(Script.Character.G11  );
            case 7:return Script.Name(Script.Character.UMP45);
        }
        return null;
    }
